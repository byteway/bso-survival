...
<div class="topnav">
    ...
    <a href="?tab=survival_02_page" <?php if($tab==='survival_02_page'):?>class="active"<?php endif; ?>>Rope Track</a>
    <a href="?tab=survival_03_page" <?php if($tab==='survival_03_page'):?>class="active"<?php endif; ?>>Step run</a>
    <a href="?tab=survival_04_page" <?php if($tab==='survival_04_page'):?>class="active"<?php endif; ?>>Obstacle course</a>
    <a href="?tab=survival_05_page" <?php if($tab==='survival_05_page'):?>class="active"<?php endif; ?>>Truck / Zip line</a>
    <a href="?tab=survival_06_page" <?php if($tab==='survival_06_page'):?>class="active"<?php endif; ?>>Survival Track</a>
    <a href="?tab=survival_07_page" <?php if($tab==='survival_07_page'):?>class="active"<?php endif; ?>>Scooping water</a>
    <a href="?tab=survival_08_page" <?php if($tab==='survival_08_page'):?>class="active"<?php endif; ?>>Carry water</a>
    <a href="?tab=survival_09_page" <?php if($tab==='survival_09_page'):?>class="active"<?php endif; ?>>Building rafts</a>
